...
songsList = $('div.songs-list');
  ...
  $('.playlists-tracks > ul').sortable({
    ...
    update:function(event,ui){
      ...
      femto.playlist.set('#queue_sortable');
...
$('#playlist li').draggable({
  ...
  start:function(event,ui){
        ...
        ui.helper.attr('style','position:absolute;width:415px;min-height:80px;height:80px;background-color:white;color:black;border:1px solid black;');
