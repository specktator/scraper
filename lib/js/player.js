  ...
  femto = {
    ...
    playlist: {
      ...
      events: function(){
        ...
        $(audio).on('playlistDelete',function(event, id){
          femto.playlist.actions.delete({'id':id});
          console.log(id);
        });
        ...
        $(audio).on('playlistsLoadAll',function(event){
          femto.playlist.actions.loadAll({'target':'ul#playlists'});
      ...
      actions: {
        ...
        loadAll:function(data){
          ...
          $.post("rq.php",{"action":"playlist","type":"loadall"},function(response){
            ...
            $('a.playlist-link').on('click',function(event){
